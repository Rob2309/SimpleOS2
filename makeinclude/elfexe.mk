...
$(output_file): $(c_objects) $(cpp_objects) $(asm_objects)
	@ mkdir -p $(dir $@)
	$(ELF_GCC) -g -nostdlib $(compile_flags) -o $@ $^ -e main -static -lgcc


$(int_dir)/%.c.o: $(src_dir)/%.c $(c_headers) $(cross_headers)
	@ mkdir -p $(dir $@)
	$(ELF_GCC) -g -ffreestanding -fno-stack-protector -fno-exceptions $(compile_defs) $(compile_flags) $(elf_include_flags) -c $< -o $@
